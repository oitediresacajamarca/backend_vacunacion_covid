...
ALMACENES_RED=[{NOMBRE_RED:'CAJAMARCA',COD_ALMACEN:'007S03',COD_ALM_ORG:'067A01'},
{NOMBRE_RED:'CAJABAMBA',COD_ALMACEN:'007S06',COD_ALM_ORG:'067A01'},
{NOMBRE_RED:'SAN PABLO',COD_ALMACEN:'007S08',COD_ALM_ORG:'067A01'},
{NOMBRE_RED:'SAN MIGUEL',COD_ALMACEN:'007S07',COD_ALM_ORG:'067A01'},
{NOMBRE_RED:'CONTUMAZA',COD_ALMACEN:'007S14',COD_ALM_ORG:'067A01'},
{NOMBRE_RED:'CELENDIN',COD_ALMACEN:'007S04',COD_ALM_ORG:'067A01'},
{NOMBRE_RED:'SAN MARCOS',COD_ALMACEN:'007S05',COD_ALM_ORG:'067A01'},
{NOMBRE_RED:'CHOTA',COD_ALMACEN:'010S05',COD_ALM_ORG:'010A01'},
{NOMBRE_RED:'BAMBAMARCA',COD_ALMACEN:'010S02',COD_ALM_ORG:'010A01'},
    ...
    async cargar_movimientos_red(@Param('COD_RED') COD_RED: string) { 
       ...
       let g= this.ALMACENES_RED.find((r)=>{return r.NOMBRE_RED==COD_RED})
        ...
        const resp = await this.movimientos_sis.find({
            where: { ALMCODIDST:g.COD_ALMACEN,MOVCODITIP:'S',ALMCODIORG:g.COD_ALM_ORG},order:{MOVFECHREG:'DESC'}
        })
